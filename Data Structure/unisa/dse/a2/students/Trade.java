...
public class Trade implements Comparable<Trade> {
	...
	{
		if (t.broker.getWatchlist().contains(t.listedCompanyCode) && this.broker.getWatchlist().contains(this.listedCompanyCode)) 
		{
			return 0;
		} 
		else if (!t.broker.getWatchlist().contains(t.listedCompanyCode) &&  this.broker.getWatchlist().contains(this.listedCompanyCode)) 
		{
			return 1;
		} 
		else if (t.broker.getWatchlist().contains(t.listedCompanyCode) && !this.broker.getWatchlist().contains(this.listedCompanyCode))
